...
{{- define "gitea.dependency.fullname" -}}
...
{{- define "mysql.dns" -}}
{{- printf "%s.%s.svc.%s:%g" (include "gitea.dependency.fullname" (dict "chartName" "mysql" "chartValues" .Values.mysql "context" .)) .Release.Namespace .Values.clusterDomain .Values.mysql.service.port -}}
{{- end -}}

{{- define "mariadb.dns" -}}
{{- printf "%s.%s.svc.%s:%g" (include "gitea.dependency.fullname" (dict "chartName" "mariadb" "chartValues" .Values.mariadb "context" .)) .Release.Namespace .Values.clusterDomain .Values.mariadb.primary.service.port -}}
{{- end -}}
